...
{
    public class UsedVevicleConfig : IEntityTypeConfiguration<UsedVehicle>
    {
        public void Configure ( EntityTypeBuilder<UsedVehicle> builder )
        {
            ...
            builder.HasData(new List<UsedVehicle>
            {
                 new() {
                    Id = 7 ,
                    ...
                    Year = "2024",
                    FuelType = CarFuelTypes.Electric,
